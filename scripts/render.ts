...
#t1:checked~.tabs label[for=t1],#t2:checked~.tabs label[for=t2],#t3:checked~.tabs label[for=t3]
{background:var(--pn2);color:var(--fg)}
#t1:checked~.panes .p1,#t2:checked~.panes .p2,#t3:checked~.panes .p3{display:block}
